...
import { LinkIcon, Profile } from '@/components/icons';
						...
						<li key={link.title}>
							<Link
								...
								className={cn(
									...
									'h-11.5 text-grey text-base font-semibold rounded-lg',
									'px-7 transition-all duration-300 ease-in-out hover:text-purple',
									'[&_svg_path]:transition-all [&_svg_path]:duration-300',
									'[&_svg_path]:ease-in-out hover:[&_svg_path]:fill-purple',
									pathname === link.href &&
										'bg-light-purple text-purple [&_svg_path]:fill-purple',
								)}>
				...
				<div className='flex items-center gap-4'>
					...
					<SignOutButton redirectUrl='/sign-in'>
						<button onClick={logout}>
							<LogOutIcon className='text-purple cursor-pointer' />
						</button>
					</SignOutButton>
				</div>
			</nav>
