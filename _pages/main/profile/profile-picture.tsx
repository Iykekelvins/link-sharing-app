...
export default function ProfilePicture({ form }: { form: UseFormReturn<FormData> }) {
	return (
		<div className='bg-light-grey mt-10 rounded-xl p-5'>
			<div className='grid items-center md:grid-cols-[0.5fr_1fr]'>
				<h3 className='text-grey text-base'>Profile picture</h3>
