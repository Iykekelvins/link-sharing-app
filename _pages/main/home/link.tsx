...
export default function Link({
	...
	const { attributes, listeners, setNodeRef, transform, transition, isDragging } =
		useSortable({ id: link.id as string });
	...
	return (
		<motion.li
			...
			<div className='bg-light-grey p-5 rounded-xl' ref={setNodeRef} style={style}>
				...
				<div className='mt-3'>
					...
					<Select
						...
						value={link.platform}
						onValueChange={(e) =>
							handleInputChange(link.id as string, 'platform', e)
						}>
						<SelectTrigger
							className={cn(
								'w-full mt-1',
							...
							onBlur={(e) =>
								handleBlur(link.id as string, 'platform', e.target.value)
							}
